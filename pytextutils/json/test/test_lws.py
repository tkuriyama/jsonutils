...
class TestSampleData:
    """Test graphs generated by sample data."""
    ...
    def test_basic_singleton_val_error(self):
        """Very basic schema and data with one value error."""
        ...
        data = {'root': {'sample': 'ERROR NODE'}}

        ERRORS = lws.return_errors()
        expected_schema = {
            ('root', 'root'): [('sample node', ERRORS['val'])]
        }
        expected_data = {
            ('root', 'root'): [('sample', ERRORS['val'])]
        }
