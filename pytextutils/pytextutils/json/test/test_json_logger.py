...
from pytextutils import json_logger
...
class TestDictToTreeHelpers:
    ...
    def test_format_node(self):
        ...
        f = json_logger.format_node
        assert f('a', '----', 1) == '|----a'
        assert f('a', '----', 2) == '     |----a'

    def test_flatten_list(self):
        """Test flattening of nested lists."""
        f = json_logger.flatten_list
        nested = [1, [2, 3, [[4], 5]]]
